...
/// <summary>
/// Where every piece of the picker goes, for both layouts. Pure - no Main, no config, no drawing - so
/// the geometry can be tested headlessly and hit testing proven to agree with what is drawn.
/// </summary>
public static class WheelLayout
{
	...
	public struct Geometry
	{
		...
		/// <summary>Where the hovered swatch's name goes. Centred for the wheel, left-aligned for the bar.</summary>
	...
	private static Geometry ComputeBar(in Settings settings, Vector2 anchor)
	{
		...
		// Beside the middle of the strip rather than above it, for the same reason as the wheel.
