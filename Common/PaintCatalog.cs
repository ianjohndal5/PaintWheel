...
public class PaintCatalog : ModSystem
{
	...
	/// <summary>
	/// Vanilla has no CoatingID class: 1 is Illuminant (ItemID.GlowPaint, fullbright), 2 is Echo
	/// (invisible). Verified against Item.SetDefaults in TML_2026_06.
	/// </summary>
	public const byte IlluminantCoating = 1;

	public const byte EchoCoating = 2;
	...
	public override void PostSetupContent()
	{
		...
		paints.Sort(static (a, b) => PaintIdOf(a).CompareTo(PaintIdOf(b)));
