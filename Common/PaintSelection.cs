...
/// <summary>
/// Thin static facade over the local player's selection. The data itself lives on
/// <see cref="PaintWheelPlayer"/> so it saves with the character and can never leak between players.
/// </summary>
